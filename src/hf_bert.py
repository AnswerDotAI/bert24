...
def create_hf_bert_multiple_choice(
    num_labels: int,
    pretrained_model_name: str = "bert-base-uncased",
    use_pretrained: Optional[bool] = False,
    model_config: Optional[dict] = None,
    ...
    if use_pretrained:
        assert (
            transformers.AutoModelForMultipleChoice.from_pretrained is not None
        ), "AutoModelForMultipleChoice has from_pretrained method"
        ...
        assert (
            transformers.AutoModelForMultipleChoice.from_config is not None
        ), "AutoModelForMultipleChoice has from_config method"
        model = transformers.AutoModelForMultipleChoice.from_config(config)
