...
class TokenRepLayer(nn.Module):
    def __init__(self, model_name: str = "bert-base-cased", fine_tune: bool = True, subtoken_pooling: str = "first",
                 hidden_size: int = 768,
                 add_tokens=["[SEP]", "[ENT]"],
                 custom_base_model: bool = False, custom_model_object: PreTrainedModel = None, tokenizer_object: PreTrainedTokenizer = None,
                 ):
        super().__init__()
        ...
        self.bert_layer = TransformerWordEmbeddings(
            ...
            custom_model_object=custom_model_object,
