...
TASK_NAME_TO_CLASS = {
    ...
    "mmlu_semipro": misc_jobs_module.MMLUSemiPro,
    "mmlu_amateur": misc_jobs_module.MMLUAmateur,
}
...
def train(config: om.DictConfig) -> None:
    ...
    round_1_task_names = {"mnli", "eurlex", "ultrafeedback", "mmlu_semipro", "mmlu_amateur"}
